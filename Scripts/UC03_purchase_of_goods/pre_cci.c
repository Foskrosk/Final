# 1 "c:\\users\\admin\\desktop\\loadrunner_final_task\\scripts\\uc03_purchase_of_goods\\\\combined_UC03_purchase_of_goods.c"
...
# 1 "c:\\users\\admin\\desktop\\loadrunner_final_task\\scripts\\uc03_purchase_of_goods\\\\combined_UC03_purchase_of_goods.c" 2
...
# 2 "c:\\users\\admin\\desktop\\loadrunner_final_task\\scripts\\uc03_purchase_of_goods\\\\combined_UC03_purchase_of_goods.c" 2
...
lr_start_transaction("open_categories_speakers");
	...
	lr_end_transaction("open_categories_speakers",2);
...
lr_start_transaction("product_selection");
	...
	lr_end_transaction("product_selection",2);
...
lr_start_transaction("Click_Checkout");
	...
	lr_end_transaction("Click_Checkout",2);
...
web_reg_find("Text/IC={userId}",
	...
	lr_end_transaction("Click_basket",2);
}
...
# 3 "c:\\users\\admin\\desktop\\loadrunner_final_task\\scripts\\uc03_purchase_of_goods\\\\combined_UC03_purchase_of_goods.c" 2
...
# 4 "c:\\users\\admin\\desktop\\loadrunner_final_task\\scripts\\uc03_purchase_of_goods\\\\combined_UC03_purchase_of_goods.c" 2

# 1 "Action.c" 1
Action()
{
lr_start_transaction("UC03_purchase_of_goods");
...
lr_think_time(2);
	...
	lr_start_transaction("Shipping_Details");
	...
	web_custom_request("GetAccountByIdRequest",
		...
		"Mode=HTML", 
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><GetAccountByIdRequest xmlns=\"com.advantage.online.store.accountservice\"><accountId>{userId}</accountId><base64Token>Basic RGVuaXMxOTg1MTpEZDEyMzQ1Njc4OTA=</base64Token></GetAccountByIdRequest></soap:Body></soap:Envelope>", 
		"LAST");
	...
	web_custom_request("GetAccountByIdNewRequest", 
		...
		"Mode=HTML", 
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><GetAccountByIdNewRequest xmlns=\"com.advantage.online.store.accountservice\"><accountId>{userId}</accountId><base64Token>Basic RGVuaXMxOTg1MTpEZDEyMzQ1Njc4OTA=</base64Token></GetAccountByIdNewRequest></soap:Body></soap:Envelope>", 
		"LAST");
	...
	web_custom_request("shippingcost", 
		...
		"Body={\"seaddress\":{\"addressLine1\":\"\",\"addressLine2\":\"\",\"city\":\"\",\"country\":\"us\",\"postalCode\":\"\",\"state\":\"\"},\"secustomerName\":\"TestLastName TestFirstName\",\"secustomerPhone\":\"22222222222\",\"senumberOfProducts\":1,\"setransactionType\":\"SHIPPING_COST\",\"sessionId\":\"EC4476BB637198BCB59C0F9FC6B5B7DA\"}", 
		"LAST");
	...
	lr_end_transaction("Shipping_Details",2);
	...
	web_custom_request("AddSafePayMethodRequest", 
		...
		"Mode=HTML", 
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><AddSafePayMethodRequest xmlns=\"com.advantage.online.store.accountservice\"><safePayUsername>{username}</safePayUsername><accountId>{userId}</accountId><safePayPassword>{password}</safePayPassword><base64Token>Basic RGVuaXMxOTg1MTpEZDEyMzQ1Njc4OTA=</base64Token></"
	...
	web_custom_request("{userId}_4",
		...
		"Body={\"orderPaymentInformation\":{\"Transaction_AccountNumber\":\"843200971\",\"Transaction_Currency\":\"USD\",\"Transaction_CustomerPhone\":\"22222222222\",\"Transaction_MasterCredit_CVVNumber\":\"\",\"Transaction_MasterCredit_CardNumber\":\"4886\",\"Transaction_MasterCredit_CustomerName\":\"\",\"Transaction_MasterCredit_ExpirationDate\":\"122027\",\"Transaction_PaymentMethod\":\"SafePay\",\"Transaction_ReferenceNumber\":0,\"Transaction_SafePay_Password\":\"{password}\",\""
		"Transaction_SafePay_UserName\":\"{username}\",\"Transaction_TransactionDate\":\"26052023\",\"Transaction_Type\":\"PAYMENT\"},\"orderShippingInformation\":{\"Shipping_Address_Address\":\"\",\"Shipping_Address_City\":\"\",\"Shipping_Address_CountryCode\":40,\"Shipping_Address_CustomerName\":\"TestLastName TestFirstName\",\"Shipping_Address_CustomerPhone\":\"22222222222\",\"Shipping_Address_PostalCode\":\"\",\"Shipping_Address_State\":\"\",\"Shipping_Cost\":269.99,\"Shipping_NumberOfProducts\":1,\""
		"Shipping_TrackingNumber\":0},\"purchasedProducts\":[{\"hexColor\":\"414141\",\"productId\":20,\"quantity\":1,\"hasWarranty\":false}]}", 
		"LAST");
...
log_out();
	...
	lr_end_transaction("UC03_purchase_of_goods",2);

	return 0;
}
# 5 "c:\\users\\admin\\desktop\\loadrunner_final_task\\scripts\\uc03_purchase_of_goods\\\\combined_UC03_purchase_of_goods.c" 2
...
# 6 "c:\\users\\admin\\desktop\\loadrunner_final_task\\scripts\\uc03_purchase_of_goods\\\\combined_UC03_purchase_of_goods.c" 2
